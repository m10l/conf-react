...
class AudioPlayerComponent extends React.Component {
  ...
  render() {
    return (
      <div className="audioplayer-component">
        <button className="audioplayer-component__play-button" onClick={this.handleTogglePlay.bind(this)} >
        ...
        <div className="audioplayer-component__audio">
          <Wavesurfer
